...
NOTE: In ASA r2 systems, SEDs are supported only for NVMe based SSD's.  

Use the ASA r2 onboard key manager or an external key manager to serve authentication keys to your nodes.

In addition to NSE, you can also enable software encryption to add another layer of security to your data. ASA r2 systems use NetApp Volume Encryption (NVE) technology to encrypt data at the software level.  NetApp Aggregate Encryption (NAE) is not supported on ASA r2 systems because the storage layer in ASA r2 systems uses storage availability zones instead of aggregates.  

Learn more about link:https://docs.netapp.com/us-en/ontap/encryption-at-rest/configure-netapp-volume-encryption-concept.html[NetApp Volume Encryption^].

Learn more about link:https://docs.netapp.com/us-en/asa-r2/learn-more/hardware-comparison.html[the differences between ASA r2 systems and other ONTAP systems].
...
// 2025 Dec 09, ONTAPDOC 3547
// 2025, Aug 12, ONTAPDOC 3051
