...
summary: "Enable ARP with AI to detects potential ransomware threats, automatically take action to protect your data, and display a warning message in System Manager to alert you of suspicious activity."
---
...
* ARP/AI is not supported on storage units protected by SnapLock.
