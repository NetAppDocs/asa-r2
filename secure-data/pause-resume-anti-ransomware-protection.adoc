...
summary: "If you are planning an unusual workload event, you can temporarily suspend ARP with AI analysis to prevent false positive detections of ransomware attacks"
---
= Pause or resume ARP/AI protection on ASA r2 storage systems
:icons: font
:imagesdir: ../media/
