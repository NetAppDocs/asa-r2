...
keywords: asa r2, secure data, data security, encrypt, data at rest, encryption, in-band authentication, in band, nvme, tcp, tls, transport layer security, secure connections, secure data connections
