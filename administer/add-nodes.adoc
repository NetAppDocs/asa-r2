...
[.lead]
Beginning in ONTAP 9.16.1, ASA r2 storage system support up to 12 nodes per cluster. After the new nodes of an HA pair have been cabled and powered on, you need to join them to the cluster. 
