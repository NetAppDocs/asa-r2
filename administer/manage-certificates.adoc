...
Use System Manager to generate a certificate signing request and to add, renew or delete a trusted certificate authority, client/server certificate or local certificate authorities.
...
. In System Manger, select *Cluster > Settings*.
. Under *Security*, next to *Certificates*, select image:icon_arrow.gif[blue arrow pointing to the right].
