...
[NOTE]
link:space-balancing.html[dynamic space balancing] is enabled by default 14 days after either upgrading to ONTAP 9.17.1 or initializing a new ONTAP 9.17.1 ASA r2 cluster. You cannot revert from ONTAP 9.17.1 on your ASA r2 system after dynamic space balancing is enabled.   
