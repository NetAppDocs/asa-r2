...
summary: Create snapshots of the consistency groups in your ASA r2 storage system to protect the data in the storage units that are part of the consistency group. 
---
