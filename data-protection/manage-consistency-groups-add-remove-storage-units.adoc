...
You can modify the default settings for new storage units when you create the storage units.  You can also link:snapshot-reserve-modify.html[modify existing storage units] to update their current settings. 
