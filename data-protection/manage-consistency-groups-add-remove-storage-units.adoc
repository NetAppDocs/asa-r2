...
.Before you begin
If the consistency group you want to modify is in an SnapMirror active sync relationship, and your are running ONTAP 9.16.1, you must break the relationship before you can modify the consistency group.
