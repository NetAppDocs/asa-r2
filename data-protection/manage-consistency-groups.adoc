...
In ONTAP 9.16.1, you must link:data-protection/snapmirror-active-sync-break-relationship.html[break the asynchronous replication relationship] and link:snapmirror-active-sync-delete-relationship.html[delete the SnapMirror active sync relationship] before making geometry changes to the consistency group.
