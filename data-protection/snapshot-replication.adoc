...
summary: Use System Manager to copy data to a remote location for backup and disaster recovery.  Set up requires creation of a replication policy and relationship. 
---
= Set up Snapshot replication on ASA r2 storage systems
:icons: font
:imagesdir: ../media/
