...
You must be link:https://docs.netapp.com/us-en/active-iq/task_login_activeiq.html[registered with Active IQ^] to view support cases for your ASA r2 system.
