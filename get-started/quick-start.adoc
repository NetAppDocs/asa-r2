...
summary: "To get started with an ASA r2 (ASA A1K, A90, A70, A50, A30, A20, C30) system, install the hardware, set up the cluster, set up data access, and provision the storage."
searchtitle: "Install and set up ASA A1K, A90, A70, A50, A30, A20 and C30 storage systems"
---
