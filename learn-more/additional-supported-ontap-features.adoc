...
=== NVMe over Fabrics (NVMe-oF) provisioning

You can use the non-volatile memory express (NVMe) protocol to provide storage on your ASA r2 system. The NVMe protocol is optimized for performance with solid state storage.

* link:https://docs.netapp.com/us-en/ontap/concept_nvme_provision_overview.html[Learn about NVMe over Fabrics (NVMe-oF)^].

=== System Manager search
