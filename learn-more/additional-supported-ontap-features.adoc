...
* link:https://docs.netapp.com/us-en/ontap/san-admin/san-host-provisioning-concept.html[Learn more about iSCSI^]
* link:https://docs.netapp.com/us-en/ontap/san-admin/san-provisioning-fc-concept.html[Learn more about Fibre Channel (FC)^]
* link:https://docs.netapp.com/us-en/ontap/concept_nvme_provision_overview.html[Learn about NVMe over Fabrics (NVMe-oF)^].
** *NVMe copy offload*: Beginning with ONTAP 9.18.1, NVMe copy offload is supported. NVMe copy offload enables an NVMe host to offload copy operations from its CPU to the CPU of the ONTAP storage controller.  The host can copy data from one NVMe namespace to another while reserving its CPU resources for application workloads.
+
