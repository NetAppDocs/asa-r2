...
Unless listed as unsupported, all other commands in the link:https://docs.netapp.com/us-en/ontap-cli/[ONTAP command reference] are supported for ASA r2 systems.
...
* `lun move-in-volume`
+
NOTE: The `lun move-in-volume` command is replaced with the `lun rename` and the `vserver nvme namespace rename` commands.
* `lun transition`
====
...
// 2026 Jun 30, ONTAPDOC-3724
// 2026 May 29, ONTAPDOC-3900
