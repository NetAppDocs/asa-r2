...
You can choose to add host initiators and map them to your storage unit during the storage unit creation process, or you can optionally choose to add your host initiators, then create and map your storage units.  New host initiators can be added and mapped to existing storage units at any time.
...
See link:https://hwu.netapp.com/[NetApp Hardware Universe^] for the most current storage limits for ASA r2 systems.
...
+
*Host mapping* refers to the host group that the new storage unit will be mapped to. If there is a pre-existing host group for the type of host you selected for your new storage unit, the pre-existing host group is auto-select for your host mapping.  You can accept the host group that is auto-selected for your host mapping or you can select a different host group.  
+
