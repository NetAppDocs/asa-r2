...
Your storage units are created and mapped to your hosts. You can now link:data-protection/create-snapshots.html[create snapshots] to protect the data on your ASA r2.
