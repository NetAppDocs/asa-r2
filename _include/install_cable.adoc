...
Connect your controllers in a network configuration where multiple nodes in a cluster are directly connected to each other, eliminating the need for a dedicated network switch.
...
.ASA A1K system
--
Connect your storage controllers to your ONTAP cluster.
...
== Step 2: Cable your storage controllers to the storage shelves
...
.Option 1: Cable controllers to one NS224 storage shelf
[%collapsible]
=====
...
// Start snippet: collapsible block (open on page load)
.Option 2: Cable controllers to two NS224 storage shelves
[%collapsible]
=====
...
// Start snippet: collapsible block (open on page load)
.Option 1: Cable controllers to one NS224 shelf
[%collapsible]
=====
...
// Start snippet: collapsible block (open on page load)
.Option 2: Cable controllers to two NS224 shelves
[%collapsible]
=====
