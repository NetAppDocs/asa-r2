...
.ASA A1K system
--
Connect your storage controllers to your ONTAP cluster connections.
...
These procedures show how to connect your controllers to one shelf and to two shelves. You can directly connect up to four shelves to your controllers.
