...
summary: Connect the ASA A20, ASA A30, or ASA A50 storage system to your network and storage shelves to enable cluster communication, management access, and SAN host connectivity.
---
