...
[.lead]
Get started with the install and setup workflow for the ASA r2 storage system and deploy it as an HA pair in your ONTAP environment. 
...
[role="quick-margin-para"]
To cable hardware, first connect the controllers to your network and then connect the controllers to your shelves.
