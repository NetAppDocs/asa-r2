...
.Before you begin
Before installing your ASA r2 system, review the link:bootmedia-replace-requirements.html[install requirements and considerations].
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png[Three]link:cable-cable.html[Cable the hardware for ASA r2]
[role="quick-margin-para"]
