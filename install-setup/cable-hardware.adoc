...
* The cluster/HA and host network cabling procedures show common configurations. If your configuration does not match the examples provided, go to link:https://hwu.netapp.com[NetApp Hardware Universe^] for comprehensive configuration and slot priority details to cable your storage system. 
...
.A20, A30, and A50
--
Connect each controller to its corresponding NSM100B module on the NS224 shelf using the storage cables included  with your storage system. The cable provided could be the following type:
