...
.A1K
--
Create the ONTAP cluster connections. For switchless clusters, cable the controllers to each other. For switched clusters, cable the controllers to the cluster network switches.
...
Connect the controllers to the switches to create the ONTAP cluster connections.
