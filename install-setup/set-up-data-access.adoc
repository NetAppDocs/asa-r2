...
ASA r2 storage units are thin provisioned by default. When migrating your VM workload, virtual disks (VMDKs) should also be thin provisioned.
...
* Learn more about link:https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_setup_Broadcom_VMware_ESXi_iSCSI_MPIO_with_ONTAP_SAN_ASA[how to set up Broadcom VMware ESXi iSCSI MPIO with ONTAP SAN ASA storage systems^].
...
Beginning with ONTAP 9.19.1, FLI supports the iSCSI protocol for backend connectivity.

* Learn more about link: https://docs.netapp.com/us-en/ontap-fli/get-started/learn-about-data-migration.html[ONTAP FLI migrations^].
...
//2026, May 07, ONTAPDOC-3708
// 2025 Dec 04, Git Issue 86
