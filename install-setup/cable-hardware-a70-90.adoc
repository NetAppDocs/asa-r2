...
summary: Learn how to cable the ASA A70 or ASA A90 storage system controllers to your network and to the shelves. 
---
...
[.lead]
After you install the rack hardware for your ASA A70 or ASA A90 storage system, install the network cables for the controllers and connect the cables between the controllers and storage shelves.
