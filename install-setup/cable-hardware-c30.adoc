...
summary: Learn how to cable the ASA C30 storage system controllers to your network and to the shelves. 
---
...
[.lead]
After you install the rack hardware for your ASA C30 storage system, install the network cables for the controllers and connect the cables between the controllers and storage shelves.
