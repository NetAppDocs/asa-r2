...
summary: Connect the ASA A1K storage system to your network and storage shelves to enable cluster communication, management access, and SAN host connectivity.
---
= Cable the hardware for the ASA A1K storage system
:icons: font
:imagesdir: ../media/

[.lead]
Connect the ASA A1K storage system to your network and storage shelves to enable cluster communication, management access, and SAN host connectivity. This procedure includes cabling for cluster/HA interconnect, management network, host network, and storage shelf connections.
...
* The I/O slots on the ASA A1K are numbered 1 through 11.
+
...
+
image::../media/drw_a1k_network_cabling1_ieops-1649.svg[Cable to 100 GbE Ethernet network,width=500px]
--
...
image::../media/oie_cable_sfp_gbe_copper.svg[10/25 GbE Ethernet cable,width=100px]

image::../media/drw_a1k_network_cabling2_ieops-1650.svg[Cable to 10/25 GbE Ethernet network,width=500px]
--
=====
...
The ASA A1K storage systems support NS224 shelves with either the NSM100 or NSM100B module. The major differences between the modules are:  
...
.. Connect port e11b to NSM B port e0b.
+
...
.. Connect port e10b to shelf 1 NSM B port e0b.
