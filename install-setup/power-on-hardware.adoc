...
include::https://raw.githubusercontent.com/NetAppDocs/ontap-systems/main/_include/install_power_hardware.adoc[]

.What's next
Go to link:initialize-ontap-cluster.html[Initialize the ONTAP cluster].