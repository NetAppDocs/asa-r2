...
// first body row
| Systems
a| The following NetApp ASA r2 systems are supported beginning with ONTAP 9.16.1.  These systems deliver a unified hardware and software solution that creates a simplified experience specific to the needs of SAN-only customers.
...
| link:../learn-more/additional-supported-ontap-features.html#san-protocols[NVMe space deallocation enabled by default]
