...
// first body row
| Platforms
a| The following NetApp ASA r2 systems are supported beginning with ONTAP 9.16.1.  These platforms deliver a unified hardware and software solution that creates a simplified experience specific to the needs of SAN-only customers.
