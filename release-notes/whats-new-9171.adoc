...
|link:../data-protection/snapshot-replication.html[Enhanced support for replication of child consistency groups]
| Replication policies can be applied directly to child consistency groups.  
|===
